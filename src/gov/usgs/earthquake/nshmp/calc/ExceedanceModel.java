...
public enum ExceedanceModel {
  ...
  XySequence treeExceedanceCombined(
    ...
    sequence.clear();
    MutableXySequence branchCurve = MutableXySequence.copyOf(sequence);
   ...
   */
  static XySequence clusterExceedance(List<MutableXySequence> curves) {
    MutableXySequence combined = MutableXySequence.copyOf(curves.get(0)).complement();
